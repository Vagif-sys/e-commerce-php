...
if(isset($_POST['change_password'])){
          ...
          //if passwod is less than 6 char
            ...
            $stmt = $pdo->prepare("UPDATE users SET user_password=:password WHERE user_email=:email");
            $stmt->execute(array('password'=> md5($password),':email'=> $user_email));
...
//get orders
 if(isset($_SESSION['loggedIn'])){
  ...
  $orders->execute(array('user_id'=>$user_id));
                          ...
                          <tr>
                              ...
                              <td>
                                <form method="POST" action="order_details.php">
                                  ...
                                  <input type="" value="<?php echo $row['order_id'];?>" name="order_id"/>
