...
if(isset($_GET['order_id'])){
  ...
  $edit_order = $pdo->prepare("SELECT * FROM orders WHERE order_id=?");
  $edit_order->execute([$order_id]);
          ...
          $edit_order = $conn->prepare("UPDATE orders SET order_status=? WHERE order_id=?");
         $edit_order->execute([$order_status,$order_id]);
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
          ...
          <div class="mx-auto container">
              ...
              <?php 
              $edit_order = $edit_order->fetchAll(PDO::FETCH_ASSOC);
              foreach($edit_order as $r){?>
