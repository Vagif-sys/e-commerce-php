...
<?php
   ...
   if(isset($_GET['product_id'])){
    ...
    $edit_p = $pdo->prepare("SELECT * FROM products WHERE product_id=?");
    $edit_p->execute([$product_id]);
       ...
       $category = $_POST['category'];
        ...
        $edit_p = $pdo->prepare("UPDATE products SET product_name=?, product_description=?, product_price=?,
                                product_special_offer=?, product_color=?, product_category=?  WHERE product_id=?");
        $edit_p->execute([$title,$description,$price,$offer,$color,$category,$product_id]);
          ...
          <div class="mx-auto container">
              <form id="edit-form"  method="POST" action="edit_product.php">
                ...
                <div class="form-group mt-2">
                 ...
                 <?php
                 $products = $edit_p->fetchAll(PDO::FETCH_ASSOC);
